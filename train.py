...
def train(config):
    ...
    vgg_model = vgg16(weights=True).features[:16]
...
if __name__ == "__main__":
    ...
    # Input Parameters
    parser.add_argument('--input_images_path', type=str, default="./trainA/",help='path of input images(underwater images) default:./trainA/')
    parser.add_argument('--label_images_path', type=str, default="./trainB/",help='path of label images(clear images) default:./trainB/')
    parser.add_argument('--lr', type=float, default=0.0001)
    parser.add_argument('--cuda_id', type=int, default=0)
    parser.add_argument('--decay_rate', type=float, default=0.7,help='Learning rate decay default: 0.8')
